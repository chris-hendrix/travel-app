 ...
 * is what an event and a leg of travel need.
 *
 * `min` and `max` are the days that make sense for what is being
 * picked. Days outside them are inert rather than miscoloured: grey text
 * is the calendar's word for "not a day you can pick here". Travel
 * passes a bound one day past the trip, because a stay is booked through
 * its last night — check-out and the flight home are the morning after.
 */
