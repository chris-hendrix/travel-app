  ...
  const mockMemberTravels: MemberTravel[] = [
    {
      ...
      memberId: "member-1",
      travelType: "arrival",
      arrivalTime: new Date("2026-07-15T10:00:00Z"),
      arrivalLocation: "SFO Airport",
    ...
    },
    {
      ...
      departureTime: new Date("2026-07-22T15:00:00Z"),
...
describe("useCreateMemberTravel", () => {
  ...
  const mockMemberTravelResponse: MemberTravel = {
    ...
    travelType: "arrival",
      ...
      flightNumber: null,
    arrivalTime: new Date("2026-07-15T14:00:00Z"),
    arrivalLocation: "LAX Airport",
    details: "Delta DL456",
    deletedAt: null,
    deletedBy: null,
...
describe("useUpdateMemberTravel", () => {
  ...
  const mockMemberTravel: MemberTravel = {
    ...
    travelType: "arrival",
      ...
      flightNumber: null,
    arrivalTime: new Date("2026-07-15T14:00:00Z"),
    arrivalLocation: "Original location",
  ...
  const mockUpdateInput: UpdateMemberTravelInput = {
    arrivalLocation: "Updated location",
