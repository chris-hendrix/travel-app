...
interface PlaceholderDetailViewProps {
...
export function PlaceholderDetailView({
  member,
  tripId,
  initialFocus,
  onBack,
  onCloseSheet,
}: PlaceholderDetailViewProps) {
  ...
  return (
    <>
      <div className="space-y-6 flex-1 overflow-y-auto" data-testid="placeholder-detail-view">
        {/* Identity hint */}
        ...
        <div className="flex justify-between pt-4 border-t border-border">
          ...
          <Button variant="outline" size="sm" className="bg-card" onClick={onBack} data-testid="placeholder-detail-done">
            Done
          </Button>
        </div>
      </div>
